...
const QuickViewModal = ({ product, onClose }) => {
  ...
  return (
    <div className="cart-overlay" style={{ justifyContent: 'center', alignItems: 'center' }} onClick={onClose}>
      <div className="quick-view-modal" onClick={(e) => e.stopPropagation()} style={{ background: 'var(--glass-bg)', padding: '2rem', borderRadius: '0', maxWidth: '500px', width: '90%', border: '1px solid var(--glass-border)', boxShadow: '0 10px 30px rgba(0,0,0,0.2)', animation: 'zoomIn 0.3s ease', position: 'relative' }}>
        ...
        <div style={{ width: '100%', height: '200px', backgroundImage: `url(${product.image})`, backgroundSize: 'cover', backgroundPosition: 'center', borderRadius: '0', marginBottom: '1.5rem', boxShadow: '0 5px 15px rgba(0,0,0,0.2)' }}></div>
